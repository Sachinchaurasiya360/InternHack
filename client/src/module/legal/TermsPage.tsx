      ...
      <main className="flex-1 px-4 pt-28 pb-16">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-100 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 text-sm font-medium mb-5">
              <ShieldCheck size={16} />
              Legal & Policies
            </div>
