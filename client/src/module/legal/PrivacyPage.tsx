...
const sections: Section[] = [
  ...
  },
  {
    ...
    list: [
      {
        label: "Google OAuth",
        text: "For social login, receives your name, email, and profile picture",
      },
      {
        label: "Google Gemini AI",
        text: "For generating resumes, cover letters, and interview content",
      },
      {
        label: "Dodo Payments",
        text: "For payment processing, subject to Dodo Payments' privacy policy",
      },
      {
        label: "AWS S3",
        text: "For storing uploaded files (resumes, documents)",
      },
      {
        label: "Email Service",
        text: "For sending transactional and marketing emails",
      },
    ],
  },
  {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 grid gap-6">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* Special inline contact link for "Your Rights" section */}
              ...
              {/* Contact CTA Banner */}
              <div className="mt-6 rounded-3xl overflow-hidden border border-indigo-200 dark:border-indigo-500/20 bg-linear-to-r from-indigo-600 to-purple-600 shadow-2xl">
