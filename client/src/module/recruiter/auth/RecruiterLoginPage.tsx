      ...
      <div className="flex-1 flex items-center justify-center px-4 pt-24 pb-8">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Recruiter Sign In</h1>
            <p className="text-gray-500 dark:text-gray-500 mt-1">Access your hiring dashboard</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 space-y-5">
            ...
            <p className="text-center text-sm text-gray-500 dark:text-gray-500">
              ...
              <Link to="/recruiter/register" className="text-indigo-600 dark:text-indigo-400 font-medium hover:underline">
