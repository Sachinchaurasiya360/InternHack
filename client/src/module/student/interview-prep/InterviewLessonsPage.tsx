...
import { CheckCircle2, ArrowRight, ArrowLeft, BookOpen, TrendingUp, Lock } from "lucide-react";
  ...
  return (
    <div className="relative pb-12">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-32 -right-32 w-150 h-150 bg-linear-to-br from-violet-100 to-purple-100 dark:from-violet-900/20 dark:to-purple-900/20 rounded-full blur-3xl opacity-40" />
      ...
      >
        <h1 className="font-display text-4xl sm:text-5xl font-bold tracking-tight text-gray-950 dark:text-white mb-3">
          Interview <span className="text-gradient-accent">Preparation</span>
        </h1>
        <p className="text-lg text-gray-500 dark:text-gray-500 max-w-lg mx-auto">
          Curated questions from basic to advanced - coding, theory, situational & more
        </p>
      </motion.div>
      ...
      >
        {[
          { icon: BookOpen, value: totalQuestions, label: "Questions", iconColor: "text-violet-500" },
          { icon: TrendingUp, value: totalCompleted, label: "Completed", iconColor: "text-indigo-500" },
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 text-[11px] text-gray-400 dark:text-gray-500 font-medium">
                      <span className="px-2 py-0.5 bg-gray-100 dark:bg-gray-800 rounded text-gray-500 dark:text-gray-400">{section.total} questions</span>
