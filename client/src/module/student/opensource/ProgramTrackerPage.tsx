...
{
    id: 11,
    slug: "freebsd-foundation-internships",
  ...
  },
{
  ...
  },
  {
    ...
    timeline: [
      { phase: "Application Open", dates: "Usually 1 month before release start" },
      { phase: "Selection & Onboarding", dates: "Release Start" },
      { phase: "Shadow Period", dates: "12-14 weeks" },
    ],
    howToApply: [
      "Watch for shadow application announcements on sig-release mailing list",
      "Fill out the application form with detail of your K8s contributions",
      "Select your preferred role (CI Signal, Bug Triage, Docs, etc.)",
      "Once selected, participate in weekly meetings and shadow tasks",
    ],
    difficulty: "Intermediate",
    focusArea: "DEVELOPMENT"
  }
...
export default function ProgramTrackerPage() {
  ...
  const programsSource: Program[] = useMemo(() => {
    if (serverPrograms && serverPrograms.length > 0) {
      return serverPrograms.map((p: any): Program => ({
        ...p,
