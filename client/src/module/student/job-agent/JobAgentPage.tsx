    ...
    <div className="flex flex-col h-[calc(100vh-4rem)] max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-800/60">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-gray-950 dark:text-white leading-tight">InternHack AI</h1>
          ...
          {isEmpty ? (
            ...
            >
              ...
              <div className="relative mb-6">
                <div className="w-20 h-20 rounded-3xl bg-indigo-600 flex items-center justify-center shadow-lg shadow-indigo-600/20">
              ...
              {!isPremium && (
                <p className="text-xs text-gray-400 dark:text-gray-500 mb-6">
                  {FREE_LIMIT} free messages — <Link to="/student/checkout" className="text-indigo-500 hover:text-indigo-600 no-underline font-medium">upgrade for unlimited</Link>
                </p>
              )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 w-full max-w-md">
                {QUICK_PROMPTS.map((q) => (
                  <button
                    ...
                    className="group flex items-center gap-3 px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl text-left hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-sm transition-all"
                  >
      ...
      {hitFreeLimit && !isPremium && (
        <div className="px-4 sm:px-6 py-3 bg-indigo-50 dark:bg-indigo-950/30 border-t border-indigo-100 dark:border-indigo-900/50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Crown className="w-4 h-4 text-indigo-500" />
              <span className="text-sm text-indigo-700 dark:text-indigo-300">Unlock unlimited AI chat with Premium</span>
            </div>
            <Link
              to="/student/checkout"
              className="px-4 py-1.5 bg-indigo-600 text-white text-xs font-semibold rounded-lg hover:bg-indigo-700 transition-colors no-underline"
            >
              Upgrade
            </Link>
          </div>
      ...
      <div className="px-4 sm:px-6 py-3 border-t border-gray-100 dark:border-gray-800/60 bg-white/80 dark:bg-gray-950/80 backdrop-blur-sm">
        <div className="flex items-center gap-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl px-4 py-1.5 focus-within:border-indigo-300 dark:focus-within:border-indigo-700 focus-within:ring-2 focus-within:ring-indigo-500/10 transition-all">
          <input
            ref={inputRef}
            type="text"
            value={input}
          ...
          <button
            ...
            className="p-2 rounded-xl bg-indigo-600 text-white disabled:opacity-30 hover:bg-indigo-700 transition-colors"
          >
