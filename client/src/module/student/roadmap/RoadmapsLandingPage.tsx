              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                {(searchInput || tag || category || (level && level !== "ALL_LEVELS")) && (
                  <button
                    ...
                    className="text-xs font-mono uppercase tracking-widest text-red-500 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-500/10 px-2 py-1 rounded transition-all cursor-pointer flex items-center gap-1"
                  >
                    <X className="w-3 h-3" />
                    Clear all filters
                  </button>
