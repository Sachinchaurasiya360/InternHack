                  ...
                  {historyData.resumes.map(
                    (r: {
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() => {
                          setLatexCode(r.latexContent);
                          setPhase("editor");
                        }}
                        className="w-full text-left p-3 rounded-md border border-stone-200 dark:border-white/10 hover:border-lime-400 transition-colors bg-white dark:bg-stone-900"
                      >
                        ...
                        >
                          <div className="flex items-start gap-3 mb-4">
                            ...
                            <div>
                              ...
                              <h3 className={sectionTitleCls + " mt-1"}>
                                Compilation failed
                              </h3>
