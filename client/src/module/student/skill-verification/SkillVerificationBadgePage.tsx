    ...
    if (error || !data) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-stone-50 dark:bg-stone-950 p-6">
                <div className="max-w-xl w-full rounded-3xl border border-stone-200 dark:border-white/10 bg-white dark:bg-stone-900 p-8 text-center shadow-lg">
        ...
        <div className="min-h-screen bg-stone-50 dark:bg-stone-950 p-6">
            ...
            <div className="max-w-3xl mx-auto">
                <motion.div
                    ...
                    className="rounded-3xl border border-stone-200 dark:border-white/10 bg-white dark:bg-stone-900 p-8 shadow-xl"
                >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <p className="text-sm uppercase tracking-[0.25em] text-indigo-600 dark:text-indigo-400 font-semibold">
                                Verified Skill
                            </p>
                    ...
                    <div className="mt-8 grid gap-4 sm:grid-cols-2">
                        <div className="rounded-2xl border border-stone-200 dark:border-white/10 bg-stone-50 dark:bg-stone-950 p-5">
                    ...
                    <div className="mt-10 rounded-3xl border border-stone-200 dark:border-white/10 bg-indigo-50 dark:bg-indigo-950/30 p-6">
