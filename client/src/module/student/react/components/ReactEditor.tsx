...
export default function ReactEditor({ value, onChange, onRun, disabled, height = "180px" }: ReactEditorProps) {
  ...
  return (
    <div className="relative bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden">
      <div className="flex items-center justify-between px-5 py-3 border-b border-gray-100 dark:border-gray-800">
        <span className="text-xs font-semibold text-gray-600 dark:text-gray-400">React (JSX)</span>
      ...
      <CodeMirror
        ...
        extensions={[javascript({ jsx: true, typescript: true }), runKeymap]}
        theme="dark"
        height={height}
        basicSetup={{
          lineNumbers: true,
