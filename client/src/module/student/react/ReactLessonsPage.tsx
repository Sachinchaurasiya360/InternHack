  ...
  return (
    <div className="relative pb-12">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-32 -right-32 w-150 h-150 bg-linear-to-br from-rose-100 to-pink-100 dark:from-rose-900/20 dark:to-pink-900/20 rounded-full blur-3xl opacity-40" />
        <div className="absolute -bottom-32 -left-32 w-125 h-125 bg-linear-to-tr from-slate-100 to-rose-100 dark:from-slate-900/20 dark:to-rose-900/20 rounded-full blur-3xl opacity-40" />
        <div
      ...
      >
        <h1 className="font-display text-4xl sm:text-5xl font-bold tracking-tight text-gray-950 dark:text-white mb-3">
          React <span className="text-gradient-accent">Lessons</span>
        </h1>
        <p className="text-lg text-gray-500 dark:text-gray-500 max-w-lg mx-auto">
          Components, hooks, state management, and more - curated for interviews
        </p>
      </motion.div>
      ...
      >
        {[
          { icon: BookOpen, value: totalLessons, label: "Lessons", iconColor: "text-rose-500" },
