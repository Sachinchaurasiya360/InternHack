  ...
  return (
    <div className="relative pb-12">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        <div className="absolute -bottom-32 -left-32 w-125 h-125 bg-linear-to-tr from-slate-100 to-green-100 dark:from-slate-900/20 dark:to-green-900/20 rounded-full blur-3xl opacity-40" />
        <div
      ...
      >
        {[
          { icon: BookOpen, value: totalLessons, label: "Lessons", iconColor: "text-green-500" },
