...
export default function BlockchainLessonsPage() {
  ...
  return (
    <div className="relative pb-12">
      <SEO title="Blockchain Lessons - Learning Hub" noIndex />
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        ...
        <div className="absolute -bottom-32 -left-32 w-125 h-125 bg-linear-to-tr from-slate-100 to-orange-100 dark:from-slate-900/20 dark:to-orange-900/20 rounded-full blur-3xl opacity-40" />
        <div
      ...
      >
        <h1 className="font-display text-4xl sm:text-5xl font-bold tracking-tight text-gray-950 dark:text-white mb-3">
          Blockchain <span className="text-gradient-accent">Lessons</span>
        </h1>
        <p className="text-lg text-gray-500 dark:text-gray-500 max-w-lg mx-auto">
          Master blockchain, Solidity, and DeFi from fundamentals to advanced — curated for interviews
        </p>
      </motion.div>
      ...
      >
        {[
          { icon: BookOpen, value: totalLessons, label: "Lessons", iconColor: "text-orange-500" },
          { icon: TrendingUp, value: totalCompleted, label: "Completed", iconColor: "text-violet-500" },
          { icon: CheckCircle2, value: `${overallPct}%`, label: "Complete", iconColor: "text-orange-500" },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="w-full h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
                      <motion.div
                        ...
                        className={`h-full rounded-full ${isComplete ? "bg-green-500" : pct > 0 ? "bg-gray-950 dark:bg-white" : "bg-gray-200 dark:bg-gray-700"}`}
                      />
                    </div>
