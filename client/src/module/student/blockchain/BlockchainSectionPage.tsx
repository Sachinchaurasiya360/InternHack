...
export default function BlockchainSectionPage() {
  ...
  return (
    <div className="relative pb-12">
      ...
      >
        {[
          { icon: BookOpen, value: sectionLessons.length, label: "Lessons", iconColor: "text-orange-500" },
          { icon: TrendingUp, value: completedCount, label: "Completed", iconColor: "text-violet-500" },
          { icon: CheckCircle2, value: `${pct}%`, label: "Complete", iconColor: "text-orange-500" },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
