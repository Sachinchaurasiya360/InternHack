  ...
  return (
    <div className="relative pb-12">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-32 -right-32 w-150 h-150 bg-linear-to-br from-sky-100 to-cyan-100 dark:from-sky-900/20 dark:to-cyan-900/20 rounded-full blur-3xl opacity-40" />
        <div className="absolute -bottom-32 -left-32 w-125 h-125 bg-linear-to-tr from-slate-100 to-sky-100 dark:from-slate-900/20 dark:to-sky-900/20 rounded-full blur-3xl opacity-40" />
        <div
      ...
      >
        <h1 className="font-display text-4xl sm:text-5xl font-bold tracking-tight text-gray-950 dark:text-white mb-3">
          Python <span className="text-gradient-accent">Lessons</span>
        </h1>
      ...
      >
        {[
          { icon: BookOpen, value: totalLessons, label: "Lessons", iconColor: "text-sky-500" },
