...
import type { TsProgress, CodeExample, PracticeExercise } from "./data/types";
  ...
  return (
    <div className="relative pb-12">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-32 -right-32 w-150 h-150 bg-cyan-100 dark:bg-cyan-900/20 rounded-full blur-3xl opacity-40" />
        <div className="absolute -bottom-32 -left-32 w-125 h-125 bg-blue-100 dark:bg-blue-900/20 rounded-full blur-3xl opacity-40" />
        <div
        ...
        <div className="flex items-center justify-between bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 px-6 py-4">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-10 h-10 rounded-xl bg-cyan-50 dark:bg-cyan-900/30 flex items-center justify-center shrink-0">
              <span className="text-sm font-bold text-cyan-600 dark:text-cyan-400">{currentIndex + 1}</span>
            </div>
      ...
      <div className="space-y-5">
        ...
        >
          {lesson.concepts.map((c) => (
            <span key={c} className="text-[10px] px-2.5 py-1 rounded-lg bg-cyan-50 dark:bg-cyan-900/20 text-cyan-700 dark:text-cyan-400 font-medium">
              {c}
            </span>
          ))}
        </motion.div>
