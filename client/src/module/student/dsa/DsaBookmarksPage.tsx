      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-8 py-8">
        ...
        {isLoading ? (
          ...
          <div className="py-20 text-center border border-dashed border-stone-300 dark:border-white/10 rounded-md flex flex-col items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-stone-900 dark:text-stone-50 mb-1">No bookmarked problems yet.</p>
            ...
            <Link
              to="/learn/dsa"
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-md text-xs font-bold bg-stone-900 dark:bg-stone-50 text-stone-50 dark:text-stone-900 hover:bg-stone-800 dark:hover:bg-stone-200 transition-colors no-underline"
            >
              Browse DSA Topics
            </Link>
          </div>
