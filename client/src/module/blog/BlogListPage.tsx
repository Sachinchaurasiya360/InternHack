  ...
  return (
    <div className="font-sans min-h-screen bg-stone-50 dark:bg-stone-950 text-stone-900 dark:text-stone-50">
      <SEO
        ...
        description="Career tips, interview strategies, salary insights, and industry trends to help you land your dream role."
        keywords="career blog, interview tips, salary guide"
