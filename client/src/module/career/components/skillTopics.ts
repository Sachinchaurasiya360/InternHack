...
export const SKILL_TOPICS: Record<string, string[]> = {
  ...
  dbms: [
    "Introduction to DBMS — types, advantages over file systems",
    "ER Model — entities, attributes, relationships, cardinality",
    "Relational Model — tuples, attributes, domains, relational algebra",
    ...
    "Indexing — B-tree, B+ tree, hashing, primary vs secondary",
    "Keys — primary, foreign, candidate, super, composite, alternate",
    "Joins — inner, outer, cross, self, natural joins",
  ...
  "computer network": [
    ...
    "IP Addressing — IPv4 vs IPv6, classful & classless, subnetting, CIDR",
    "TCP vs UDP — connection-oriented vs connectionless, use cases",
    "HTTP & HTTPS — methods, status codes, headers, TLS/SSL",
    "DNS — domain resolution, record types, recursive vs iterative queries",
    "Routing — static vs dynamic, RIP, OSPF, BGP",
    "Switching — circuit vs packet switching, VLANs",
    "ARP, RARP, ICMP — address resolution, error reporting",
    "Network Devices — hub, switch, router, gateway, bridge",
    "Firewalls & Network Security — IDS/IPS, DMZ, ACL",
    "Socket Programming — TCP/UDP sockets, client-server model",
  ],
  "computer fundamental": [
    "Computer Organization — CPU, ALU, CU, memory, I/O",
    "Von Neumann vs Harvard Architecture",
    "Number Systems — binary, octal, decimal, hexadecimal, conversions",
    "Logic Gates — AND, OR, NOT, NAND, NOR, XOR, XNOR",
    "Boolean Algebra — laws, simplification, K-maps",
    "Memory Hierarchy — registers, cache (L1/L2/L3), RAM, disk",
    "RAM vs ROM — types (SRAM, DRAM, PROM, EPROM, EEPROM)",
    "Compiler vs Interpreter — phases of compilation",
    "Input/Output Devices — types, interfaces, interrupt-driven I/O",
    "Data Representation — fixed & floating point, ASCII, Unicode",
    "Assembly Language Basics — instructions, registers, addressing modes",
  ...
  "operating system": [
    ...
    "Process Synchronization — critical section, Peterson's solution",
    "Semaphores & Mutex — binary semaphore, counting semaphore, monitors",
    ...
    "System Calls — types (process, file, device, communication)",
  ...
  hld: [
    ...
    "Caching Strategies — CDN, Redis, write-through, write-back, cache-aside",
    ...
    "API Design — REST vs GraphQL vs gRPC, rate limiting, pagination",
    "Design URL Shortener — hashing, Base62, analytics",
    "Design Chat System — WebSockets, message queues, presence service",
    "Design News Feed — fan-out, ranking, real-time updates",
    "Design File Storage — chunking, replication, metadata service",
  ],
  lld: [
    ...
    "Design Patterns — Behavioral (Observer, Strategy, Command, State)",
    "UML Diagrams — class diagrams, sequence diagrams, use case diagrams",
    "Composition vs Inheritance — IS-A vs HAS-A, when to use each",
    "Design Parking Lot — classes, spot allocation, pricing strategies",
    "Design Library Management — book lending, member management, fines",
    "Design Elevator System — scheduling algorithms, state machines",
    "Design Tic-Tac-Toe — board representation, win detection, player turns",
    "Interface Design — abstraction, encapsulation, polymorphism",
    "Code Quality — DRY, KISS, YAGNI, clean code principles",
  ],
  aptitude: [
    "Number System — divisibility rules, HCF, LCM, factors",
    "Percentages — increase, decrease, successive percentages",
    "Profit & Loss — cost price, selling price, markup, discount",
    "Simple & Compound Interest — formulas, difference, applications",
    "Ratio & Proportion — direct, inverse proportion, partnerships",
    "Time & Work — individual rates, combined work, pipes & cisterns",
    "Time, Speed & Distance — relative speed, trains, boats & streams",
    "Averages & Mixtures — weighted average, alligation",
    "Permutations & Combinations — nPr, nCr, applications",
    "Probability — basic, conditional, Bayes' theorem, complementary",
    "Ages Problems — present age, ratio-based, difference equations",
