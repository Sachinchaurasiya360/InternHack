...
const CardSwap = ({
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement(child)
      ? cloneElement(
          child as React.ReactElement<React.HTMLAttributes<HTMLDivElement> & { ref?: React.Ref<HTMLDivElement> }>,
          {
            key: i,
            ref: refs[i],
            style: { width, height, ...((child.props as React.CSSProperties) ?? {}) },
            onClick: (e: React.MouseEvent<HTMLDivElement>) => {
              (child.props as React.HTMLAttributes<HTMLDivElement>).onClick?.(e);
              onCardClick?.(i);
            },
          }
        )
