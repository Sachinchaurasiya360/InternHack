  ...
  const plans: PlanData[] = [
    {
      ...
      features: [
        ...
        { text: "AI repo matching & recommendations", included: false },
        { text: "Mentor matching access", included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "AI repo matching & recommendations", included: true },
        { text: "Mentor matching access", included: true },
