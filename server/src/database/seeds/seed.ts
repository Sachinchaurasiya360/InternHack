...
async function seedBlogPosts() {
  ...
  const posts = [
    ...
    { title: "How to Crack DSA Interviews: A Step-by-Step Roadmap", slug: "how-to-crack-dsa-interviews", content: "Data structures and algorithms remain the backbone of most technical interviews. Start with arrays, strings, and hashmaps before moving to trees, graphs, and dynamic programming. Build a study plan around patterns (sliding window, two pointers, BFS/DFS, backtracking) rather than memorizing individual problems. Aim to solve 150-200 well-chosen problems across difficulty levels, and always revisit problems you struggled with after a few days. In interviews, narrate your thought process, discuss time and space complexity, and test your solution with edge cases before declaring it done.", excerpt: "A practical, pattern-based roadmap to mastering DSA interviews.", category: "INTERVIEW_TIPS" as const, tags: ["dsa", "interview", "coding"], status: "PUBLISHED" as const, readingTime: 9, publishedAt: new Date("2026-04-08") },
    { title: "System Design Interview Tips for New Grads", slug: "system-design-interview-tips", content: "System design interviews evaluate how you think about scale, trade-offs, and ambiguity rather than syntax. Begin by clarifying requirements and scope before sketching anything. Walk through a high-level architecture, then drill into specific components like load balancers, caching layers, and database choices, explaining trade-offs as you go. Familiarize yourself with core concepts such as horizontal scaling, sharding, replication, CAP theorem, and message queues. For entry-level roles, interviewers care more about structured thinking and clear communication than encyclopedic knowledge.", excerpt: "How to approach system design interviews even with limited experience.", category: "INTERVIEW_TIPS" as const, tags: ["system-design", "interview", "architecture"], status: "PUBLISHED" as const, readingTime: 8, publishedAt: new Date("2026-04-10") },
    { title: "The Complete Behavioral Interview Guide", slug: "behavioral-interview-guide", content: "Behavioral interviews assess how you handle real workplace situations using your past experiences as evidence. Use the STAR method (Situation, Task, Action, Result) to structure answers concisely and concretely. Prepare 5-7 core stories covering conflict resolution, leadership, failure and learning, and working under pressure, then adapt them to whatever question is asked. Avoid vague generalities; specific numbers and outcomes make your answers memorable. Always end with what you learned or would do differently.", excerpt: "Master the STAR method and prepare stories that leave a lasting impression.", category: "CAREER_ADVICE" as const, tags: ["behavioral", "interview", "soft-skills"], status: "PUBLISHED" as const, readingTime: 7, publishedAt: new Date("2026-04-12") },
    { title: "How to Write a Resume That Gets You Noticed", slug: "how-to-write-a-strong-resume", content: "A strong resume tells a focused story in under a page. Lead with impact: use action verbs and quantify results wherever possible, such as 'reduced page load time by 40%' instead of 'worked on performance'. Tailor your skills and project sections to match the job description, and keep formatting clean and consistent so both humans and parsing systems can read it easily. Cut anything that doesn't support your candidacy for the specific role, and proofread relentlessly; small errors signal carelessness.", excerpt: "Practical principles for building a resume that stands out for the right reasons.", category: "RESUME_TIPS" as const, tags: ["resume", "job-search", "career"], status: "PUBLISHED" as const, readingTime: 6, publishedAt: new Date("2026-04-15") },
    { title: "Top HR Interview Questions and How to Answer Them", slug: "top-hr-interview-questions", content: "HR rounds often decide cultural fit after your technical skills are already validated. Be ready for questions like 'Tell me about yourself', 'Why this company', 'Where do you see yourself in five years', and 'What's your biggest weakness'. Keep answers honest, concise, and aligned with the role and company values. Research the company's mission and recent work beforehand so your answers feel specific rather than generic. Always prepare a few thoughtful questions to ask the interviewer in return.", excerpt: "Common HR interview questions for freshers and how to answer them confidently.", category: "CAREER_ADVICE" as const, tags: ["hr", "interview", "freshers"], status: "PUBLISHED" as const, readingTime: 5, publishedAt: new Date("2026-04-17") },
    { title: "How to Prepare for Coding Rounds Under Time Pressure", slug: "how-to-prepare-for-coding-rounds", content: "Coding rounds test not just correctness but how you work under a ticking clock. Practice on a plain editor without autocomplete to simulate real interview conditions, and time yourself solving medium-difficulty problems in 25-30 minutes. Read the problem twice before coding, write a brute-force approach first if you're stuck, then optimize. Keep your code clean and modular so it's easy to debug live. Always run through a couple of test cases, including edge cases, before submitting.", excerpt: "Build speed and accuracy for timed coding rounds with deliberate practice.", category: "INTERVIEW_TIPS" as const, tags: ["coding", "interview", "practice"], status: "PUBLISHED" as const, readingTime: 7, publishedAt: new Date("2026-04-19") },
    { title: "Common Mistakes to Avoid in Technical Interviews", slug: "common-mistakes-technical-interviews", content: "Many strong candidates lose offers to avoidable mistakes rather than lack of skill. Jumping straight into code without clarifying requirements often leads to solving the wrong problem. Staying silent while thinking makes it hard for interviewers to follow or help you. Ignoring edge cases, ignoring time complexity, and refusing to ask for hints when stuck are also common pitfalls. Treat the interview as a collaborative conversation rather than a solo exam, and it becomes much easier to recover from a rough start.", excerpt: "The recurring pitfalls that cost candidates otherwise winnable interviews.", category: "INTERVIEW_TIPS" as const, tags: ["interview", "mistakes", "career"], status: "PUBLISHED" as const, readingTime: 6, publishedAt: new Date("2026-04-21") },
  ];
