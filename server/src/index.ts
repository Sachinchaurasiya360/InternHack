...
import interviewScheduleRouter from "./module/interview-schedule/interview-schedule.routes.js";
...
app.use("/api/interview-experiences", interviewExperienceRouter);
app.use("/api/interviews", interviewScheduleRouter);
